...
if __name__ == "__main__":
    ...
    # name_classes = ["_background_", "scrape", "scale"]
    # name_classes = ["background", "In", "Pa", "Sc"]
    name_classes = ["_background_", "blowhole", "break", "crack", "fray", "uneven"]
    # ----------------------------------------------------------------------------------------------------------#
